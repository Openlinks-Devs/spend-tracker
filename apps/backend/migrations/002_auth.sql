-- Better Auth core tables (generated via @better-auth/cli generate).
-- Additive only: creates the four auth tables and their indexes. Touches no
-- existing table and inserts no data.
